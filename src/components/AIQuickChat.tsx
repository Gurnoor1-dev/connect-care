...
export function AIQuickChat() {
  ...
  return <>
    {open && <div className="fixed bottom-24 right-4 z-[70] flex w-[min(calc(100vw-2rem),390px)] flex-col overflow-hidden rounded-[1.5rem] border border-border/70 bg-background/95 shadow-2xl backdrop-blur-xl sm:right-6 sm:bottom-28">
      <div className="flex items-center justify-between border-b border-border/70 bg-secondary/40 px-4 py-3.5">
